    ...
    return (
        <View style={estilos.Pagina}>
            ...
            <View style={estilos.NavegacaoPagina}>
                ...
                <Pressable style={estilos.BotaoDireito}><Image style={estilos.ImagemDireita} source={require('../../../../assets/imgs/setaDireita.png')}/></Pressable>
            </View>
            <Pressable style={estilos.BotaoAdicionar}><Image style={estilos.ImagemAdicionar} source={require('../../../../assets/imgs/adicionar.png')}/></Pressable>
        </View> 
    )
}
